...
<p>Travel Terms and Conditions
    These website standard terms and conditions (‘Terms and Conditions’) contained herein on this webpage, shall govern your use of this website, including all the pages within this website https://www.EDestinations.pk (‘Website’). These Terms and Conditions, as may be amended from time to time, apply in full force and effect to your use of this Website. By accessing, browsing and using this Website and / or completing a reservation or making an online payment, you unconditionally and irrevocably accept and agree to these Terms and Conditions governing your use of the Website (the “Agreement”). Should you not agree to be bound by these Terms and Conditions laid herein, you shall not access or use any part of the Website. These Terms constitute a binding legal agreement between you as an individual user and EDestinations (Pvt.) Limited (where the context so permits, the “Owner” / “Company”).
    ...
    Scope of Services
    Through our Website, the Company provides an online forum through which you as the user can browse through different types of (i) accommodations (for example (ii) international and domestic airline tickets, (iii) airport cab (transfer) services, (iv) bus tickets, and (v) travel insurance. By making a reservation or booking through this Website, you enter into a direct (legally binding) contractual relationship with the accommodation / or airline / or bus operator / or cab service provider / or insurance provider which you book (the “Provider”). From the point at which you make your reservation or booking, we act solely as an intermediary between you and the Provider, transmitting the details of your reservation to the relevant accommodation provider, airline ticket provider, cab service provider, bus operator provider, and insurance provider.
    ...
    By accepting the Terms and Conditions stated herein you (the user) hereby accept, acknowledge and warrant that you (i) have not been involved in any criminal and/or fraudulent activity (ies) whatsoever, whether currently and/ or in the past and you have never been charged of any criminal offence in the past; (ii) have no link or connection with any banned or terrorist organization nor have been involved with the commission or glorification of any offence deemed offensive and/or prohibited and/ or punishable under the laws of the Islamic Republic of Pakistan.
    ...
    Use the Website to build a competitive product or service.12 (s) By placing an order through the Website, you hereby represent and warrant that you are not subject to any prohibitions or restrictions by any sanctions program, or subject to any penalties under any anti-money laundering regime
    ...
    The Company does not guarantee that: (i) the functions, services and security features provided in the Website will be uninterrupted or free from error; (ii) errors or failure will be repaired; or (iii) the site or the server provides services that are free from viruses, malware or harmful components;
    ...
    By purchasing airline or bus tickets or by purchasing insurance from our Website you hereby agree to provide the Company your Internet Protocol (IP) address, which might be utilized by the Company anytime to trace/locate/find the user in an event of occurrence of any fraudulent/terrorist activity by the user having a detrimental/injurious/damaging effect on the Company.
    Tickets may be issued by a Quality Aviation (Pvt.) Limited, an associated company (at the time being) of the Owner of the Website or by the Company itself. 
    You assure, represent and warrant that you will use this Website to make only legitimate reservations i.e. you have a genuine and valid visa issued by the relevant embassy or consulate. You can book online for up to 9 seats per booking. The bookings are subject to applicable fare conditions and seat vacancies in that fare group and seats being available. Seat (s) and fares are not guaranteed until the payment is being made and until you receive an E-Ticket (electronic ticket) email.  
    Currently there are following methods of making payment for online reservations made using the Website:
    Payment via credit card/debit card on the Web/App
    Payment via credit card/debit card at ST Branch/Store
    Payment via cash at the ST Branch/Store
    Payment via Jazz Cash
    Payment via Easypaisa
    Payment via NIFT ePay
    Payment via 1Bill Bank Transfer 
    Payment via HBL Direct Transfer
    Payment via Sasta Wallet
    Merchant Fees may be incurred on some methods of making a payment. In case of any cancellations, changes, or refunds; Merchant Fees may or may not be refundable depending on the method chosen to make the payment. The Company will not be liable for any Merchant Fees that is not refunded.
    ...
    selling or otherwise commercializing any Website material;
    using this Website in any way that is, or may be damaging to this Website;
    using this Website contrary to applicable laws and regulations, or in any way , that causes or may cause, harm to the Website, or to any person or business entity; and
    engaging in any data mining or data extracting or any other similar activity in relation to this Website or while using this Website.
    Cancellations
    ...
    In addition to other remedies and recourse available to the Company under this Agreement or under applicable law, the Company may limit the your activity, warn other users of the your actions, immediately suspend or terminate the User’s registration, or refuse to provide the User with access to the Website under the following conditions: 
    ...
    C) the Company believes that the your actions may infringe on any third-party rights or breach any applicable law or otherwise result in any liability for the User, other users of the Company, or the Company itself.
    ...
    Governing Laws
    This Agreement and its Terms and Conditions herein shall be governed, construed, interpreted and dealt with in accordance with the laws of Pakistan. The courts at Karachi shall have exclusive jurisdiction to try any matter in relation hereto.
    ...
    Airport Transfer means the cab service that exclusively cater to the needs of User intending to travel from and to the Airport. The service provided is intercity in nature and shall not facilitate the User to book intercity Airport drops.

    Role of EDestinations.pk and Limitations of Liability

    EDestinations does not operate cab services on its own. In order to provide a comprehensive choice of cab services, cab types and prices to users, it has tied up with Cab Operators. EDestinations only acts as a facilitator between the Cab Operator and User. The transaction is always between the Cab Operator and the User.
    ...
    Cab Operator is obligated to commence the trip as soon as the User boards the Cab. User shall report to EDestinations in case the driver denies to commence the trip for any reason whatsoever.

    Users shall board the Cab on or within such time as informed at the time of booking or provided in the booking voucher. In case the User fails to board the cab within the given timeline, Cab Operator will have the liberty to cancel the booking without informing the User.

    Users will not have any right, title or interest in the Cab provided for the given trip.
    ...
    Users shall stop and take breaks at specified places only. Users shall avoid taking additional breaks except in case of emergency.

    Users shall be responsible and liable for their own safety and security of luggage. EDestinations shall not be responsible for any loss to User or their luggage in any event.

    In the event of any dissatisfaction with any of the services provided by Cab Operator or EDestinations, the matter must be reported directly to Cab Operator or EDestinations, in order that appropriate action may be taken to remedy the problem
    ...
    Do’s and Dont’s of the User

    The User Shall

    Book the cab 24 hours prior to the journey because EDestinations only books a cab if booking is made 24 hours in advance.
    ...
    Bus Booking
    General Guidelines:
    If a passenger arrives after the departure time and misses the bus, no refund will be given.
    Passengers are advised to take care of their belongings at all times. Company will not be responsible in case of loss of luggage. 
    To maintain the safety standards, it is requested that the passengers cooperate with the security personnel in order to avoid any inconvenience or safety issue. 
    Pets are not allowed to board the bus.
    Any harmful substances/chemicals, liquors, liquids and perishable items are strictly prohibited to carry for the purpose of travel.
    Any passenger who is intoxicated will not be allowed to board the bus under any circumstances
    No cash refunds will be entertained from counters or branch offices.
    Adjusted amount will not be adjusted for any new bus order at any point in time. 
    For cancellations or refunds, please contact us on 111 172 782 or over email, chat or Whatsapp us at +923047772782
    Kainat Travels:
    Bus tickets are refundable up to 7 hours before departure.
    0% deduction charges if informed at least 6hrs before departure
    30% deduction charges if requested 3 hrs before departure
    50% ticket amount will be charged if there is a request for cancellation within 2hrs of departure
    No refund and seat shift compliance available after bus departure time
    If a passenger needs to change their tickets due to any circumstances, they can do it once only and it will be free of cost.
    Changes can be madeif requested 12 hours prior to the departure. 
    Tickets will become non-refundable if changes are requested after a 12-hour window.
    Daewoo Services:
    Passengers must present themselves at the counter 15-minutes before departure time to avoid confirmed ticket cancellation.
    Late comers would be accommodated subject to seat availability in the same bus. 
    If a passenger reports at the counter after the bus departs and does not avail next departure, the ticket will become non-refundable.
    In case the bus does not operate as per schedule, either the customer will be given a 100% refund as per Daewoo terms and conditions or the seat can be moved to the next available bus for that specific route. Please contact http://EDestinations.pk for further details
    If the passenger misses a bus, no refund will be provided under any circumstances or if Daewoo refuses to allow the passenger to board for any reason.
    If a passenger faces boarding related issues, they can directly contact the Daewoo terminal incharge.
    Bus ticket cancellation will be valid if the customer cancels the ticket at least 3 hours before departure time. 
    Any ticket cancelled within 01 hour of the bus departure will be considered as non- refundable and non-changeable. 
    In case of ticket cancellation, the customer will be charged a 30% penalty. 
    This 30% will be charged on the original ticket price and not the discounted one. This means if the ticket was bought from EDestinations on discount and you have cancelled the ticket for any reason, the company will deduct 30% of the original ticket price.
    The remaining amount of the ticket price will be automatically transferred into your bank account. 
    Skyways:
    ...
    The bus will depart as per the scheduled departure time and will stop only at Skyway’s designated stopover.
    ...
    In case of force majeure, Skyways & EDestinations shall not be responsible for any delay/cancellation in departure/arrival of the bus. No claims/damages shall be applicable in such cases.
    Waraich Express:
    Bus tickets are non-refundable/non-transferable.
    The seat(s) selected by the passenger and the seat(s) assigned on boarding the bus might vary depending on the capacity remaining in the bus.
    In case of force majeure, Waraich Express & EDestinations shall not be responsible for any delay/cancellation in the departure/arrival of the bus. No claims/damages shall be applicable in such cases.
    In case the bus does not operate as per schedule, either the customer will be given a 100% refund or the seat can be moved to the next available bus for that specific route. Please contact EDestinations. pk for further details.
    Silk Line
    Passengers must present themselves at the counter at least 15-minutes before departure.
    Free cancellation on tickets if cancellation is initiated more than 3 hours before departure.
    In case of ticket cancellation within 3 hours of bus departure and more than 2 hours before bus departure, the customer will be charged a 30% penalty.
    In case of ticket cancellation within 2 hours of bus departure, the ticket will be non-refundable and non-changeable.
    Any ticket cancelled after bus departure is non-refundable and non-changeable.
    In case of force majeure, Silkline & EDestinations shall not be responsible for any delay/cancellation in departure/arrival of the bus. No claims/damages shall be applicable in such cases.
    In case the bus does not operate as per schedule, either the customer will be given a 100% refund or the seat can be moved to the next available bus for that specific route. Please contact EDestinations.pk for further details.
    FMBT Express
    Passengers must present themselves at the counter at least 15-minutes before departure.
    Free cancellation on tickets if cancellation is initiated more than 3 hours before departure.
    ...
    In case of ticket cancellation within 2 hours of bus departure, the ticket will be non-refundable and non-changeable.
    Any ticket cancelled after bus departure is non-refundable and non-changeable.
    In case of force majeure, FMBT & EDestinations shall not be responsible for any delay/cancellation in departure/arrival of the bus. No claims/damages shall be applicable in such cases.
    In case the bus does not operate as per schedule, either the customer will be given a 100% refund or the seat can be moved to the next available bus for that specific route. Please contact EDestinations.pk for further details.
    Insurance Terms
    ...
    It is a customer’s responsibility to read all details of the travel insurance policy and to understand terms and conditions. Claims can be made through contacting a EDestinations.pk Customer Service representative.

    You can find more information of the travel insurance policies sold on EDestinations.pk here.
    ...
    Once established, booking/reservation staff shall ensure the expectant mother will be carrying valid documents i.e. MEDIF and Ultra Sound report.
    The permissible limit of pregnancy is up to 32-35 weeks i.e. expectant mothers shall not be accepted for carriage if they exceed this limit. Please ensure that their date of travel must not fall in the 35th week of pregnancy.
    Provision of ultra-sound report has been made mandatory to ascertain the gestational age of the fetus. This is in addition to the existing requirement of Medical Certificate.
    In case of non-provision of mandatory documents (i.e. ultra sound report and MEDIF), passengers will be politely refused.
    In case of connecting passengers arriving by other Interline Carriers, expectant mother will be allowed to continue their journey with the assumption that necessary checks have been carried out by other carrier
    Terms and Conditions: EDestinations Sasta Refund
    ...
    The Service must be purchased at the time of booking and may not be added after the booking. The Service must be purchased for all passengers on the booking. EDestinations may not offer the Service on every EDestinations booking. EDestinations reserves the right to deny the purchase of the Service to any customer for any lawful reason.

    When to Make Cancellations

    Except as provided below in Section 6 and specifically for the airlines Flyjinnah, Air Arabia, Air Arabia Abu Dhabi, and all international route flights, you must cancel your trip with EDestinations at least one minute (1) prior to the departure of the first or outgoing leg (“Cancel Deadline”) of your itinerary. No reason will be required to make a qualified cancellation.

    For Flyjinnah, Air Arabia, Air Arabia Abu Dhabi, and all international route flights, cancellations or modifications must be made at least twenty-four hours (24 hours) before the departure time of the first or outgoing leg (“Cancel Deadline”).

    After the applicable Cancel Deadline has passed, the purchased Service will expire, and any cancellations to your booking thereafter will be subject to the fare rules imposed by the airline or carrier for your dates. In the case of a ‘RETURN’ booking, you can only cancel the complete or partial trip ONLY once. It is also important to note you can either modify or cancel once for free, per booking.

    The price paid to add or avail the Sasta Refund feature/service is non-refundable under any and all circumstances except in the case of involuntary cancellation. In all other cases, a 100% refund guarantee applies to the price paid for the flight ticket(s) only.

    Exclusions

    The Service does not apply to the following:
    ...
    For detailed information regarding your existing change policy from the respective airline carrier, visit the airline’s website

    Terms and Conditions: EDestinations Flight Date Change Service
    ...
    The Service must be purchased at the time of booking, and may not be added after the booking. The Service must be purchased for all passengers on the booking. EDestinations may not offer the Service on every EDestinations booking. EDestinations reserves the right to deny the purchase of the Service to any customer for any reason.
    If you have purchased a Service for any EDestinations booking, you may make qualified changes for each passenger in your booking ONCE directly in the EDestinations app/website / or via a customer support agent over call, email, or chat.
    Except as provided below in Section 12, you must change your trip in the EDestinations app / website / or via a customer support agent over call, email or chat at least 1 minute prior to your first scheduled departure or prior to the cancellation of such flight by the airline** (“Change Deadline”). No reason will be required to make a qualified change. After the Change Deadline has passed, the purchased Service will expire and any changes or cancellations to your booking thereafter will be subject to the fare rules imposed by the airline or carrier for your dates.
    If you submit a change, the new itinerary must depart within 6 (6) months from the originally purchased flight departure time.
    Qualified changes are changes to the date, time, origin or destination airport.
    You may not use the Service to cancel a booking and receive a full or partial refund from EDestinations.
    If you use the Service to make a qualified change, EDestinations will not be liable for any difference of fare that must be incurred.
    Most qualified changes can be made directly via the EDestinations chat/email or call helplines without further payment. However, you may be required to pay the costs of any change at the time of the change.
    The Service is only valid for the booking for which the Service was purchased. The Service is not transferable and cannot be carried over to any future bookings.
    ...
    The Service does not apply following the earlier of:
    cancellation of any flight by an airline carrier for any reason, including the result of a force majeure event;
    ...
    a designation by the World Health Organization (WHO) that the destination city, country, or region of your EDestinations trip is at risk from COVID-19.
    ...
    The Service cost is non-refundable.
    The Service ensures that airline tickets purchased on the EDestinations app can be changed for any reason without incurring additional change fees. EDestinations provides its customers with the Service to provide a more seamless and flexible experience for travel booked with EDestinations. The Service Terms are not intended to constitute an offer to insure, do not constitute insurance or an insurance contract, and do not take the place of insurance obtained or obtainable by you.
    **exceptions apply & are subject to change. Airblue changes are not allowed 4 hours prior to scheduled flight takeoff.
    Sasta Reward / Sasta Cash Terms and Conditions
    Eligibility: Sasta Cash can only be earned and redeemed by registered members.
    Earning Cashback: To qualify for cashback, members must be logged in before booking. Logging in after booking (e.g., at payment) disqualifies the user from earning Sasta Cash.
    Platform Usage: Sasta Cash can be earned on all EDestinations.pk platforms but redeemed exclusively through the EDestinations.pk mobile app.
    Reward Discretion: EDestinations.pk determines how much Sasta Cash can be earned and used for each booking, subject to change based on user activity and booking type.
    Expiry: Sasta Cash expires after a set period, which will be communicated upon reward. EDestinations.pk reserves the right to change expiration terms without prior notice.
    Program Changes: The Sasta Rewards program may be modified, replaced, or canceled by EDestinations.pk at any time without notice, and without any liability for damages or compensation.
    Terms Modification: EDestinations.pk may amend the terms and conditions of the Sasta Rewards program or the general terms without prior notice, effective immediately.
    Non-Transferability: Sasta Cash is non-transferable and cannot be exchanged for cash or transferred between accounts.
    Refund Policy: ST reserves the right to refund Sasta Cash utilized on an order. To process your reward refund request, please send an email to support@EDestinations.pk. However, please note that Sasta Cash will not be refunded for cancellations or bookings involving the following airlines:
    -FlyJinnah
    -Airarabia
    -Flynas
    -Flyadeal
    -Jazeera Airways
    Fraud Prevention: EDestinations.pk reserves the right to revoke or adjust Sasta Cash if fraudulent activity is suspected.
    Account Suspension: EDestinations.pk may suspend or terminate a user’s account and Sasta Cash balance for violating program terms or misuse.
    Limitation of Liability: EDestinations.pk will not be liable for any direct, indirect, or consequential damages resulting from participation in the Sasta Rewards program, including the loss or expiration of rewards.
    Force Majeure: EDestinations.pk is not liable for any failure to fulfill its obligations under the program due to circumstances beyond its control (e.g., natural disasters, technical issues).
    Errors and Omissions: EDestinations.pk is not responsible for typographical or system errors that may affect the accrual, redemption, or display of Sasta Cash.
</p>
@endsection