        ...
        <div class="container-fluid container-fluid-max">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="flight-selection">
                        <div class="step step-1 active">
                            ...
                            <span class="step-text">1 Select Departing Flight (KHI - DXB)</span>
                        </div>
                        <div class="step step-2">
                            <span class="step-number">2</span>
                            <span class="step-text">Select Returning Flight (DXB - KHI)</span>
                        </div>
                    </div>
                    <!-- <div class="sho">
                        <div class="shops">
                ...
                <div class="col-md-12 col-lg-9">
                    <!-- CONTENT SECTIONS -->
                    <div class="tab-content active" id="suggested">
                        <h3>Suggested Flights</h3>
                        <x-flights :flightData="$data" :paxCount="$paxCount" />
                    </div>
                    <div class="tab-content" id="cheapest">
                        <h3>Cheapest Flights</h3>
                         <x-flights :flightData="$data" :paxCount="$paxCount" />
                    </div>
                    <div class="tab-content" id="fastest">
