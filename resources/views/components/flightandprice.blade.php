            ...
            <ul>
                ...
                <li>
                    <p><i class="fa-regular fa-calendar"></i>
                        {{ $flightData['departureFlight']['departureDate'] ?? '--' }}</p>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="d-flex flex-column">
        @if (!empty($flightData['departureFlight']))
            <div class="der-time der-time3 mb-2">
                <ul>
                    <li>
                        <h2>{{ $flightData['departureFlight']['departureTime'] }}</h2>
                    </li>
                    <li>
                        <div class="stays">
                    ...
                    <li>
                        <div class="tims">
                            <h2>{{ $flightData['departureFlight']['arrivalTime'] }}</h2>
                        </div>
                    </li>
                </ul>
                <div class="citys citys2">
                    <div class="cit">
                        <ul>
                            <li>
                                <p>{{ $flightData['departureFlight']['originCode'] }}</p>
                            </li>
                            <li>
                                <p>{{ $flightData['departureFlight']['isConnected'] ? '1 Stop' : 'Nonstop' }}</p>
                            </li>
                            <li>
                                <p>{{ $flightData['departureFlight']['destinationCode'] }}</p>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        @if (!empty($flightData['returnFlight']))
            <div class="der-time der-time3 mb-2">
                <ul>
                    ...
                    <li>
                        <div class="tims">
                            <h2>{{ $flightData['returnFlight']['arrivalTime'] }}</h2>
                        </div>
                    </li>
                </ul>
                <div class="citys citys2">
