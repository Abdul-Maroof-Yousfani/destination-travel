...
<style>
    ...
    .modern-calendar::-webkit-calendar-picker-indicator {
    ...
    .modern-calendar::-webkit-calendar-picker-indicator:hover {
    ...
    .dropdowns .quantity button:hover {
        background: #e8e8e8;
    }

    .dropdowns .error-limit {
        color: red;
        font-size: 12px;
        padding-top: 5px;
    }
    ...
    .multi-city-segments-container::-webkit-scrollbar {
        width: 8px;
    }

    .multi-city-segments-container::-webkit-scrollbar-track {
        background: #f1f1f1;
        border-radius: 10px;
    }

    .multi-city-segments-container::-webkit-scrollbar-thumb {
        background: #888;
        border-radius: 10px;
    }

    .multi-city-segments-container::-webkit-scrollbar-thumb:hover {
        background: #555;
    }
