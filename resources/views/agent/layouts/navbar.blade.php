<header class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="{{ route('agent.dashboard') }}">{{ config('app.name') }}</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('agent.dashboard') }}">Home</a>
        </li>
        @can('view dashboard')
          <li class="nav-item">
            <a class="nav-link" href="{{ route('agent.orders') }}">Orders</a>
          </li>
        @endcan
